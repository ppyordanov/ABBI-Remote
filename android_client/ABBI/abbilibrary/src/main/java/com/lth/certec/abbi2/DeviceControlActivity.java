...
public class DeviceControlActivity extends Activity {
    ...
    private void displayAbbiUiValues(String charact, byte[] data) {
        ...
        switch (charact) {
            case ABBIGattAttributes.BatteryLevel_UUID:
                ABBIGattAttributes.batteryLevel = dataint;
                updateBatteryLevel(dataint);
                break;
            case ABBIGattAttributes.VolumeLevel_UUID:
                ABBIGattAttributes.volumeLevel = dataint;
                updateMainVolumeLevel(dataint);
                break;
            case ABBIGattAttributes.SoundCtrl_UUID:
                ABBIGattAttributes.soundCtrl = dataint;
                boolean soundOn  = ABBIGattAttributes.soundCtrl == ABBISoundCtrl.SoundOn;
                boolean soundOff = ABBIGattAttributes.soundCtrl == ABBISoundCtrl.SoundOff;
                updateMuteSwitch(soundOff);
                updateSoundCtrlButton(soundOn);
                break;
            case ABBIGattAttributes.AudioMode_UUID:
                ABBIGattAttributes.audioMode = dataint;
                updateAudioMode(dataint);
                break;
            case ABBIGattAttributes.AudioContinuous_UUID:
                ABBIGattAttributes.audioContinuous = new AudioContinuous(data);
                break;
            case ABBIGattAttributes.AudioStream1_UUID:
                ABBIGattAttributes.audioStream1 = new AudioIntermittent(data);
                break;
            case ABBIGattAttributes.AudioStream2_UUID:
                ABBIGattAttributes.audioStream2 = new AudioIntermittent(data);
                break;
            case ABBIGattAttributes.AudioBPM_UUID:
                ABBIGattAttributes.audioBPM = dataint;
                break;
            case ABBIGattAttributes.AudioPlayback_UUID:
                ABBIGattAttributes.audioPlayback = dataint;
                break;
            case ABBIGattAttributes.Accelerometer_UUID:
                ...
                break;
            case ABBIGattAttributes.Gyroscope_UUID:
                //Todo: Do something with gyroscope data
                break;
            case ABBIGattAttributes.Magnetometer_UUID:
                //Todo: do something with magnetometer data
                break;
            case ABBIGattAttributes.IMU_UUID:
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            if (uuid.equals(ABBIGattAttributes.Battery_Service_UUID)){
                ABBIGattAttributes.batteryService = gattService;
                ABBIGattAttributes.readBatteryLevel();
            }
            else if (uuid.equals(ABBIGattAttributes.Custom_Service_UUID)){
            ...
            else if (uuid.equals(ABBIGattAttributes.Motion_Service_UUID)) {
